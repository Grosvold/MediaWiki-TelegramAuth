...
## Статус `city4people-wiki.ru`

[Вики](https://ru.wikipedia.org/wiki/Вики) Горпроектов была запущена в сентябре 2020 года в качестве эксперимента.
Её попробовали [в&nbsp;Пензенском отделении](https://vk.com/city4people_pnz) для упорядочивания местных задач.
Сайт закрылся в ноябре 2021 года из-за отсутствия интереса у сообщества и со стороны федерального штаба ГП.

Этот репозиторий содержит инструкции по развёртыванию и поддержке инфраструктуры для вики-движка.
Содержимое удалённых страниц сохранено в папку [`legacy`](./legacy/).
